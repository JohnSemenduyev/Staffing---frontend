...
export const ScheduleTableControls: React.FC<ScheduleTableControlsProps> = ({
    ...
    const showPrint = !hideActionButtons && !hidePrintButton;
    const showExcel = !hideActionButtons && !hideExcelButton;
    const showEdit = !hideActionButtons && !hideEditButton;
    const showRightToolbar = showPrint || showExcel || showEdit;
        ...
        <div className="flex justify-between items-center gap-2 p-4 border-t bg-gray-50 rounded-b-2xl">
            {isEditMode ? (
                <div className="flex gap-2">
                    ...
                    {!hideActionButtons && !hideCancelButton && (
                        <button
                ...
                <div className="flex items-center gap-2">
                    ...
                    {showEdit && (
                        <button
                            ...
                            title={!isEditMode && editBlocked ? "Exit actual time edit mode first" : isEditMode ? "Exit Edit Mode" : "Enter Edit Mode"}
                        >
