...
export const GeoLocationSetup = () => {
  ...
  const { fetchGeoLocations, createGeoLocation, updateGeoLocation, loading, error, geoLocations, submitLoader, submitError, deleteGeoLocation } = useGeoLocation();
  ...
  const filteredAndSortedData = useMemo(() => {
    let filtered = geoLocations; // Add filtering if needed
    if (sortConfig.key) {
      filtered.sort((a, b) => {
        let aValue: any = "";
        let bValue: any = "";
