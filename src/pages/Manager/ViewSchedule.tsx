...
export const ViewSchedule = () => {
  ...
  const handleDateSubmit = (date: string) => {
    ...
    // Generate mock schedule data based on the selected date and client
    const selectedDate = new Date(date);
    const weekRange = getWeekRangeFromDate(selectedDate);
    setCurrentWeekRange(weekRange);
    
    // Mock schedule data - you should replace this with actual API call
    const mockScheduleData: ScheduleItem[] = [
      {
        ...
        clientName: selectedClient?.name || "Sample Client",
        address: selectedClient?.address || "Sample Address",
        userName: "John Doe",
